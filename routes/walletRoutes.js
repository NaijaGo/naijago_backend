...
router.post('/withdraw', protect, async (req, res) => {
    const { bank_code, account_number, account_name, amount, password, wallet_type } = req.body;

    if (!bank_code || !account_number || !account_name || !amount || !password || !wallet_type) {
    ...
    try {
        ...
        // 2. Determine which wallet to withdraw from
        let newBalance;
        ...
        } else if (wallet_type === 'user') { // Assuming 'user' or 'app' for the user's wallet
        ...
        // 3. Prepare and call Flutterwave Transfers API
        ...
        // 4. Handle Flutterwave response and save changes
